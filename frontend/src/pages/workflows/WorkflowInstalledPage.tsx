  ...
  return (
    <Box sx={{ px: 3, py: 3 }}>
      ...
      {isLoading ? (
        ...
        <Card sx={{ minHeight: 190 }}><CardContent sx={{ textAlign: 'center', py: 6 }}><AccountTree sx={{ fontSize: 48, color: 'text.disabled', mb: 2 }} /><Typography variant="h6" color="text.secondary">暂无安装的工作流</Typography><Typography variant="body2" color="text.secondary" sx={{ mt: 1, fontSize: 13 }}>前往工作流市场安装工作流</Typography></CardContent></Card>
      ) : (
